...
const soundcite1 = function soundcite1Func(window, document, callback) { // http://stackoverflow.com/questions/2170439/how-to-embed-javascript-widget-that-depends-on-jquery-into-an-unknown-environmen
...
const soundcite2 = function soundcite2Func(soundcite_elements, $Popcorn, $SoundCloud) {
...
export default function initSoundcite() {
  ...
  setTimeout(() => {
    soundcite1(window, document, soundcite2);
  }, 50); // TK WHY
}
